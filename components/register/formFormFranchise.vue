<template>
  <div class="light">
    ...
    <v-row v-if="!$route.query.referral_code" justify="end">
      <v-col cols="auto">
        <app-btn 
          ...
          text
        >
          <span class="app-body-medium text-decoration-underline">
            {{ $t('login.goToOffers') }}
          </span>
        </app-btn>
      </v-col>
              ...
              <v-row no-gutters>
                ...
                <v-col cols="12">
                  <app-text-field
                    ...
                    :label="`${$t('login.middleName')}*`"
                    :label-style="'black--text'"
                    :rules="[rules.required]"
                    autocomplete="off"
                    @input="edit($event, 'middle_name')"
                  />
                </v-col>
                <!-- <v-col cols="12">
                  <app-text-field
                ...
                <v-col class="pb-0 pr-3" cols="6">
                  <app-text-field
                    :error-messages="errorMessages.postalCode"
                ...
                <v-col cols="12">
                  <app-text-field
                    :value="userDataObject.referral_code"
